# Task 2 — RiskVerdictHero component

**Files:** Create `src/components/RiskVerdictHero.tsx`

The traffic-light hero block at the top of the Summary tab. Pure presentational. Renders a colored dot containing the numeric score, the verdict word, and a one-line tally.

---

- [ ] **Step 1: Implement the component**

Create `src/components/RiskVerdictHero.tsx`:
...
```bash
git add src/components/RiskVerdictHero.tsx
git commit -m "feat(ui): RiskVerdictHero — traffic-light + numeric score block"
```
